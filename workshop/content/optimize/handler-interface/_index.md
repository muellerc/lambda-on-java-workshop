...
```bash
sam package --template-file lab-2-optimize/handler-interface/template.yaml \
    --output-template-file lab-2-optimize/handler-interface/packaged.yaml \
    --s3-bucket $SAM_ARTIFACT_BUCKET
sam deploy --template-file lab-2-optimize/handler-interface/packaged.yaml \
