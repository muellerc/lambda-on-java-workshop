...
```bash
sam package --template-file lab-2-optimize/reducing-dependencies/template.yaml \
    --output-template-file lab-2-optimize/reducing-dependencies/packaged.yaml \
    --s3-bucket $SAM_ARTIFACT_BUCKET
sam deploy --template-file lab-2-optimize/reducing-dependencies/packaged.yaml \
